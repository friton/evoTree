...
\begin{figure}[!t]
	\centering
	\includegraphics[width=6cm]{ucbl.jpg}
	\hspace{\fill}
...
>>>>>>> 2114a54c2abb48e9621851251d904c71808a4d4b
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=9cm]{multipleExtinction.png}
		\caption{Exemple d'arbre obtenu avec l'agorithme fourni}
	\end{figure}
	\paragraph{}
	Le fonctionnement de l’algorithme de base est décrit dans le papier Modeling Trees with a Space Colonization Algorithm (\href{http://algorithmicbotany.org/papers/colonization.egwnp2007.pdf}{\emph{Runions et al, 2007}})
	\paragraph{}
	...
	\begin{enumerate}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=14cm]{sc.jpg}
		\end{figure}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=9cm]{sc2.jpg}
		\end{figure}
