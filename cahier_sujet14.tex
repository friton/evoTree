...
\section{Contexte biologique}
	...
	Les trois chercheurs de l'Équipe Bioinformatique, Phylogénie et Génomique Évolutive à LBBE (UCBL Lyon 1), D. M. de Vienne, J.-P. Flandrois et L. Guéguen se sont interessés à la sensibilisation de ces grandes extinctions sur la biodiversité pour le grand public. L'idée serait de retracer ces événements à l'aide d'un site web interactif, qui pourra par la suite être exploité au sein de musées. 
