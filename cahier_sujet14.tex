...
<<<<<<< HEAD
	Les trois chercheurs Damien M. de Vienne, Jean-Pierre Flandrois et Laurent Guéguen se sont interessés à la sensibilisation de ces grandes extinctions sur la biodiversité pour le grand public. 
=======
	Les trois chercheurs de l'Équipe Bioinformatique, Phylogénie et Génomique Évolutive à LBBE (UCBL Lyon 1), D. M. de Vienne, J.-P. Flandrois et L. Guéguen ce sont interessé à la sensibilisation de ces grandes extinctions sur la biodiversité pour le grand public. L'idée serait de retracer ces événements à l'aide d'un site web interactif, qui pourra par la suite être exploité au sein de musées. 
>>>>>>> f8fb406c64b0e9bbd9aa15f5b8b36b9b28332bc0

\section{Analyse des besoins}

	L'idée serait de retracer ces événements à l'aide d'un site web interactif, qui pourra par la suite être exploité au sein de musées. 

	\subsection{Besoins spécifiques du projet}

		Pour cela, un site internet retraçant l'histoire de la Vie en explicitant les crises biologiques qui se sont déroulés lors des temps géologiques.
