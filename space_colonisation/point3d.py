...
class attr_point(point3d):
    ...
    def get_closest_point(self,lp,max_x,min_x):
        ...
        Takes:
            ...
            - max_x (float): float above which we don't need to check attraction points 
            - min_x (float): float under which we don't need to check attraction points
